import { FileAsset, Rule } from 'sanity'

export function fileValidation(rule: Rule): Rule {
  return rule
    ...
    .warning('Sanity cannot validate file size at this stage. Please ensure files are under 2MB.')
}
